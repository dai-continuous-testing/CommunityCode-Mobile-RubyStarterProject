...
class DemoAndroidWebTest < Test::Unit::TestCase
  def setup
    opts = {
      capabilities: {
        ...
        browserName: 'chrome',
        'digitalai:testName': 'Android Web Demo',
        'digitalai:accessKey': TestUtils.get_access_key,
        'digitalai:deviceQuery': "@os='android'",
  ...
  def test_AndroidWebDemo
    @driver.manage.timeouts.implicit_wait = 10
    @driver.get("https://demo-bank.ct.digital.ai/")
    wait = Selenium::WebDriver::Wait.new(:timeout => 10)
    wait.until { @driver.find_element(:xpath => "//*[@data-auto='login-logout']") }
